...
import todotask.example.demo.model.*;
...
class ProjectServiceTest {
    ...
    void createGroup_noMultipleGroupsConfig_And_undoneGroupsExists_throwsIllegalStateException() {
        ...
        //and
        TaskConfigurationProperties mocConfig = getTaskConfigurationProperties(false);
    ...
    void createGroup_configurationOk_And_noProjects_throwsIllegalArgumentException() {
        ...
        //and
        TaskConfigurationProperties mocConfig = getTaskConfigurationProperties(true);
    ...
    private TaskConfigurationProperties getTaskConfigurationProperties(boolean b) {
    ...
    @Test
    @DisplayName("should throw IllegalArgumentException when configured   to allow just one group  and no groups and no project for a given id")
...
//
        //system under test
        var toTest = new ProjectService(mockRepository, inMemoryGroupRepo, serviceWithInMemRepo, mocConfig);
