...
import todotask.example.demo.logic.ProjectService;
import todotask.example.demo.model.Project;
import todotask.example.demo.model.ProjectStep;
...
public class ProjectController {
    ...
    String createGroupFake(
            ...
            Model model,
            @PathVariable int id,
            @DateTimeFormat(pattern = "yyyy-MM-ddT'T'HH:mm") LocalDateTime deadline
    ){
